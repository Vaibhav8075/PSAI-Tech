        ...
        <div className="container-custom relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
            ...
            <p className="text-muted-foreground">
              Request a quote or discuss your IT and manpower requirements with our team.
            </p>
          </motion.div>
                  ...
                  {[
                    {
                      ...
                      value: 'Z-24, Zone-1, Maharana Pratap Nagar, Bhopal - 462011, Madhya Pradesh, India',
                    },
                    { icon: Phone, label: 'Phone', value: '+91 755 422-9295 / 422-3295' },
                    { icon: Mail, label: 'General Email', value: 'info@xtranetindia.com' },
                    { icon: Clock, label: 'Business Hours', value: 'Mon – Sat: 09:00 AM – 06:00 PM' },
                  ].map(item => (
